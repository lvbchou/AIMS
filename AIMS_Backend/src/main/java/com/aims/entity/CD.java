...
import java.util.*;
@Entity @Table(name="cd") @PrimaryKeyJoinColumn(name="product_id")
@Getter @Setter @NoArgsConstructor
public class CD extends DiscProduct {
    @ElementCollection
    @CollectionTable(name="cd_artist",schema="aims",joinColumns=@JoinColumn(name="product_id"))
    @Column(name="artist_name") private List<String> artists=new ArrayList<>();
    ...
    public CD(String title,String category,String barcode,String image,
              ...
              String genre,LocalDate releaseDate,List<String> artists,String recordLabel){
