...
@Component
public class NewspaperValidator extends ProductValidator<NewspaperInfoDTO> {

    public NewspaperValidator(ProductCommonValidator commonValidator) {
        super(commonValidator);
    }

    @Override
    public String getSupportedType() { return "NEWSPAPER"; }

    @Override
    protected void validateTypeFields(NewspaperInfoDTO newspaper) {
