...
@Component
public class BookValidator extends ProductValidator<BookInfoDTO> {

    public BookValidator(ProductCommonValidator commonValidator) {
        super(commonValidator);
    }

    @Override
    public String getSupportedType() { return "BOOK"; }

    @Override
    protected void validateTypeFields(BookInfoDTO book) {
