...
@Component
public class DVDValidator extends ProductValidator<DVDInfoDTO> {

    public DVDValidator(ProductCommonValidator commonValidator) {
        super(commonValidator);
    }

    @Override
    public String getSupportedType() { return "DVD"; }

    @Override
    protected void validateTypeFields(DVDInfoDTO dvd) {
