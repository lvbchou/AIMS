...
class ProductServiceTest {
    ...
    class SearchProduct {
        ...
        @Test
        @DisplayName("Should return products matching keyword and category")
        ...
        void shouldReturnEmptyWhenNoMatch() {
            when(productRepository.searchByKeywordAndCategory(anyString(), anyString()))
                    .thenReturn(List.of());

            List<Product> results = productService.searchProduct("xyz", "unknown");
